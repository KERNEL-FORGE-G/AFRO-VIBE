...
export const InboxScreen = () => {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      ...
      case 'comment':
        return <SVGIcon name="comment" size={16} color={COLORS.primary} />;
      case 'follow':
        return <SVGIcon name="profile" size={16} color={COLORS.accent} />;
      default:
...
const styles = StyleSheet.create({
  ...
  actionBtn: {
    ...
    backgroundColor: COLORS.cardBackground, borderRadius: 15,
    borderWidth: 1, borderColor: COLORS.border,
  },
